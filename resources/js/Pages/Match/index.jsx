        ...
        <>
                                        ...
                                        {navigation.map((item) => (
                                            <a
                                                ...
                                                className={classNames(
                                                    item.current ? 'bg-red-900 text-black' : 'text-gray-300 hover:bg-red-900 hover:text-black',
                                        ...
                                        <div>
                                            {
                                                auth.user ? (
                                                    ...
                                                    <>
                                                        <a href="/register" className='rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-red-900 hover:text-black uppercase'>Register</a>
                                                        <a href="/login" className='rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-red-900 hover:text-black uppercase'>Login</a>
                                                    </>
                                                )
                                            }
                                        </div>
            ...
            <div className="grid w-3/4 shadow-lg mx-auto mt-4">
                <div className="grid text-center gap-4 p-5 font-extrabold">
                    ...
                    <div className="grid grid-cols-3 items-center">
                        <div className="flex flex-col justify-between items-center">
                            <img src="https://www.pssi.org/files/uploads/club/logo_url/2017/Oct/09/59db3b8bc9256/id-140x92.png?token=0ba48f74da007fa4bfaf996bb0559131" alt="indo" className="w-20" />
                            <span>Indonesia</span>
                        </div>
                        <div className="flex flex-col items-center justify-between gap-5">
                            <span className="text-xl font-bold">VS</span>
                            <Button className={'border border-red-500 w-max mx-auto px-4 py-2'}>Beli Tiket</Button>

                        </div>
                        <div className="flex flex-col items-center justify-between">
                            <img src="https://www.pssi.org/files/uploads/club/logo_url/2017/Oct/29/59f5fbc952d55/laos-140x92.png?token=03cc59fd1d26595996b8aa160d3fdf74" alt="laos" className="w-20" />
                            <span>Laos</span>
                        </div>
                    </div>
                </div>
                <div className="grid border p-4 bg-slate-100/50">
                    ...
                    <p className="text-center font-extrabold">MANAHAN STADIUM, SURAKARTA</p>
                </div>
                ...
                <div className="grid text-center bg-slate-100/50 p-4 border gap-4">
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            <img src="https://www.pssi.org/files/uploads/club/logo_url/2018/Apr/02/5ac217744d919/bahrain-_x70.png?token=a78a26e15fcadca21e2a95398c74059e" className="w-10" />
                            <span>Bahrain</span>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-2">
                ...
                <div className="grid text-center bg-slate-100/50 p-4 border gap-4">
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            <img src="https://www.pssi.org/files/uploads/club/logo_url/2017/Oct/23/59edfc54506b0/china-_x70.png?token=c96a49b24299b33978012669cc9e1095" alt="china pr" className="w-10" />
                            <span>China PR</span>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-2">
                ...
                <div className="grid text-center bg-slate-100/50 p-4 border gap-4">
                    ...
                    <div className="flex items-center justify-center gap-2">
                        <div className="flex items-center gap-2">
                            <span>Jepan</span>
                            <img src="https://www.pssi.org/files/uploads/club/logo_url/2023/Nov/28/6565912548407/japan-_x70.png?token=bd8d111e7db03d8ed98fb50e472660dc" alt="jepan" className="w-10" />
                        </div>
                        <div className="border flex gap-2 px-4 py-2">
                            <span>
                                {/* score home */}
