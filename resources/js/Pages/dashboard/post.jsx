...
export default function Post({ posts }) {
    ...
    const [dataPost, setDataPost] = useState(null) // Ubah ke null
                        ...
                        <div className="p-6 text-gray-900">
                            ...
                            <table className="min-w-full border-collapse border border-gray-200 mb-8">
                                ...
                                <tbody>
                                    ...
                                    {dataPost && <ModalEdit open={openModalEdit} setOpen={() => setOpenModalEdit(false)} post={dataPost} authorName={author} />}
...
function ModalEdit({ open, setOpen, post, authorName }) {
    ...
    const { data: dataEdit, setData: setDataEdit, post: postEdit, reset } = useForm({
        title: post.title,  // Pastikan menggunakan nilai dari post
        content: post.content,  // Pastikan menggunakan nilai dari post
        image: null,
        _method: 'PUT'  // Tambahkan ini untuk Laravel
    });
