        ...
        <>
            ...
            <div className="w-full">
                <div className="flex flex-wrap justify-center p-6 gap-6">
                    {/* Card 1 */}
                    <div className="bg-white shadow-md rounded-md w-64 max-w-full flex-shrink-0 group transition-transform duration-300 transform hover:scale-105">
                        <div className="overflow-hidden rounded-t-md">
                            <img
                                ...
                                alt="Timnas Senior"
                                className="rounded-t-md w-full h-48 sm:h-40 lg:h-48 object-cover transform transition-transform duration-300 group-hover:scale-110"
                            />
                        </div>
                        <div className="p-4">
                            <a
                    ...
                    <div className="bg-white shadow-md rounded-md w-64 max-w-full flex-shrink-0 group transition-transform duration-300 transform hover:scale-105">
                        ...
                        <div className="p-4">
                            ...
                            >
                                <h3 className="font-bold text-lg mb-2 text-black group-hover:text-red-500 transition-colors duration-300">
                                    Erick Thohir Soroti Potensi Besar Esports:
